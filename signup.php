...
<body>
  ...
  <form class="modal-content" action="action_page.php"  method="POST" id="mynewform">
    <div class="container">
      <h1>Sign Up</h1>
      ...
      <input type="password" placeholder="Enter Password" name="word" required>
      ...
      <label for="role"><b>Select Role To Play</b></label>
